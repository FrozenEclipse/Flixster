...
private const val YOUTUBE_API_KEY = "AIzaSyChlK8I7w-YeLE4E9ejrwuSa1bGXsPaFjY"
...
class DetailActivity : YouTubeBaseActivity() {
    ...
    private fun initializeYoutube(youtubeKey: String, popularity: Double) {
